        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-stone-500">
              No material modeled savings concentration was detected.
            </p>
          </div>
          <span className="rounded-full bg-stone-100 px-3 py-1 text-xs font-medium text-stone-600">
            Stable spend profile
          </span>
        </div>
        <div className="mt-5 rounded-xl border border-dashed border-stone-200 bg-stone-50 px-4 py-5 text-sm leading-6 text-stone-600">
          The report still includes benchmark context and operational checks, but it does not force savings where the submitted inputs do not support them.
        </div>
      </div>
    );
  }
